...
try {
    if (isset($_POST['signup'])) {
        ...
        $result = mysqli_query($conn, "INSERT INTO admininfo (username, password, email, fname, phone, type) VALUES ('$_POST[uname]', '$_POST[password]', '$_POST[email]', '$_POST[fname]', '$_POST[phone]', '$_POST[type]')");
